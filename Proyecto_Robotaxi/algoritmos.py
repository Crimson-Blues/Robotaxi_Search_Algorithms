...
import time
from modelos import Node  # <--- Importante
...
def preferred_search_depth(world_matrix):
    # Esto es solo un ejemplo, aquí iría tu lógica de Profundidad (LIFO)
    # Por ahora llamamos a amplitud para que el código no falle al probar
    return preferred_search_amplitude(world_matrix)
